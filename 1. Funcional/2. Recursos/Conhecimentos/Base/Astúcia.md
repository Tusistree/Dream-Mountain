...
Texto. Realiza um **Ataque** contra o **Oponente**, porém com apenas metade do **Dano**. A ultima **Habilidade** usada por aquele **Alvo** não pode ser usada novamente até o seu próximo **Turno**.

### Disparo de Aviso

Habilidade Física, Ofensivo, Projétil.

**Precisão Difícil** e **Custa** 3 pontos de **Mana**.

Um disparo para deixar todos atentos. Consome uma de qualquer **Munição**, mas sem realizar um **Ataque**. Causa 1 **Efeito** de **Medo** em todos os **Oponentes** dentro do seu **Alcance**. Não pode ser usado no mesmo **Combate** depois de um acerto.

### Passagem

Talento Físico, Mobilidade e Ofensivo.

Um movimento breve que sempre deixa uma lembrança. Quando em **Movimento**, se você atravessar um **Oponente** você pode realizar um pequeno **Ataque** nele sem consumir **Ações**, porém com o **Dano** fixo em 1, **Puro** e sem escalar com **Ataque** ou **Maestria**, mas causando totalmente os **Efeitos** adicionais de um **Ataque**. **Passagem** não pode ser repetida múltiplas vezes no mesmo **Oponente** em apenas um **Turno**.
